        ...
        <div className="card shadow p-4">
          ...
          <div className="row g-2 mb-4">
            ...
            <div className="col-md-auto">
              <button onClick={handleSearch} className="btn btn-dark">Generate Invoice</button>
            </div>
          </div>
            ...
            <div id="invoiceArea" className="border p-4">
              ...
              <table className="table table-bordered">
                <thead className="table-light">
                  <tr><th>Description</th><th>Size</th><th>Rate</th><th>Total</th></tr>
                </thead>
                <tbody>
                  <tr>
                ...
                <div className="col-md-4">
                  <table className="table table-bordered">
                    <tbody>
                      ...
                      <tr className="table-success"><td><b>Total Paid</b></td><td><b>{invoiceData.paid}</b></td></tr>
              ...
              <div className="mt-4 d-flex gap-2">
                ...
                <button onClick={exportPDF} className="btn btn-danger">Download PDF</button>
              </div>
