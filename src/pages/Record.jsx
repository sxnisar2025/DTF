...
export default function Record() {
  ...
  const exportExcel = () => {
    ...
    saveAs(new Blob([excelBuffer]), "records.xlsx");
  };
        ...
        <div className="bg-white p-6 rounded-xl shadow">
          ...
          <div className="flex flex-wrap justify-between items-center gap-2 mb-4">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <button onClick={() => setShowForm(true)} className="bg-black text-white px-4 py-2 rounded">+ Add Data</button>
            </div>
          </div>
            ...
            <table className="w-full border text-sm">
              ...
              <tbody>
                {filteredRows.length === 0 ? (
                  <tr>
                    <td colSpan="12" className="text-center p-6">No data found</td>
                  </tr>
                ) : (
              ...
              <tfoot className="bg-gray-100 font-semibold">
                <tr>
                  <td colSpan="10" className="border p-3 text-right">Total Amount</td>
